...
_$GearApiModelImpl _$$GearApiModelImplFromJson(Map<String, dynamic> json) =>
    _$GearApiModelImpl(
      ...
      gearMeshSizeInFinger:
          (json['gear_mesh_size_in_finger'] as num?)?.toDouble(),
...
_$CatchApiModelImpl _$$CatchApiModelImplFromJson(Map<String, dynamic> json) =>
    _$CatchApiModelImpl(
      ...
      estimatedWeightInGrams:
          (json['estimated_weight_in_grams'] as num?)?.toDouble(),
      ...
      publishedWeightInGrams:
          (json['published_weight_in_grams'] as num?)?.toDouble(),
      pricePerKg: (json['price_per_kg'] as num?)?.toDouble(),
      finalPrice: (json['final_price'] as num?)?.toDouble(),
      publishedInMarketPlace: json['published_in_market_place'] as bool?,
      fishCatchImages: (json['fishCatchImages'] as List<dynamic>?)
              ?.map((e) =>
...
Map<String, dynamic> _$$CatchApiModelImplToJson(_$CatchApiModelImpl instance) =>
    <String, dynamic>{
      ...
      'fishCatchImages':
          instance.fishCatchImages.map((e) => e.toJson()).toList(),
      'note': instance.note,
...
_$UpdateCatchResponseImpl _$$UpdateCatchResponseImplFromJson(
    ...
    _$UpdateCatchResponseImpl(
      fishCatch:
          CatchApiModel.fromJson(json['fishCatch'] as Map<String, dynamic>),
