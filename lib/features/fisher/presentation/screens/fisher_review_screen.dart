...
class FisherReviewScreen extends StatefulWidget {
  final String userId;

  const FisherReviewScreen({super.key, required this.userId});

  @override
  State<FisherReviewScreen> createState() => _FisherReviewScreenState();
}

class _FisherReviewScreenState extends State<FisherReviewScreen> {
  @override
  void initState() {
    super.initState();
    // Start loading user and reviews when the screen initializes
            ...
            builder: (context, state) {
              ...
              if (state is ReviewsLoaded) {
                ...
                if (data.totalReviews == 0) {
                  return Center(child: Text('This user has no reviews yet.'));
                }
